...
create_dashboard (void)
{
  ...
  image11 = create_pixmap (dashboard, "engagement1 (copie).png");
  gtk_widget_show (image11);
  gtk_fixed_put (GTK_FIXED (fixed1), image11, 0, 368);
  gtk_widget_set_size_request (image11, 616, 312);

  button1 = gtk_button_new ();
  gtk_widget_show (button1);
  gtk_fixed_put (GTK_FIXED (fixed1), button1, 40, 200);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), button3, 48, 312);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), button2, 320, 200);
  gtk_widget_set_size_request (button2, 224, 88);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), button4, 320, 312);
...
create_mod (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed2), button_mod, 632, 400);
  ...
  label33 = gtk_label_new_with_mnemonic (_("<b><span\ncolor='purple'>Classe :</span></b>"));
  ...
  label36 = gtk_label_new_with_mnemonic (_("<b><span\ncolor='purple'>Service :</span></b>"));
  ...
  image15 = create_pixmap (mod, "index.png");
  gtk_widget_show (image15);
  gtk_fixed_put (GTK_FIXED (fixed2), image15, 0, 0);
  gtk_widget_set_size_request (image15, 192, 136);
  ...
  gtk_label_set_mnemonic_widget (GTK_LABEL (label34), mod2);
  gtk_label_set_mnemonic_widget (GTK_LABEL (label35), mod3);
...
create_af (void)
{
  ...
  image14 = create_pixmap (af, "images.jpeg");
  gtk_widget_show (image14);
  gtk_fixed_put (GTK_FIXED (fixed3), image14, 480, 472);
  gtk_widget_set_size_request (image14, 392, 128);
  ...
  GLADE_HOOKUP_OBJECT (af, image14, "image14");
...
create_aj (void)
{
  ...
  aj6 = gtk_entry_new ();
  gtk_widget_show (aj6);
  gtk_fixed_put (GTK_FIXED (fixed4), aj6, 144, 264);
  ...
  label13 = gtk_label_new_with_mnemonic (_("<b><span\ncolor='purple'>ID :</span></b>"));
  ...
  aeg = gtk_label_new_with_mnemonic (_("<b><span\ncolor='purple'>Pr\303\251nom :</span></b>"));
  gtk_widget_show (aeg);
  gtk_fixed_put (GTK_FIXED (fixed4), aeg, 32, 112);
  gtk_widget_set_size_request (aeg, 112, 24);
  gtk_label_set_use_markup (GTK_LABEL (aeg), TRUE);

  label14 = gtk_label_new (_("<b><span\ncolor='purple'>Nom :</span></b>"));
  ...
  label16 = gtk_label_new_with_mnemonic (_("<b><span\ncolor='purple'>Description :</span></b>"));
  ...
  image13 = create_pixmap (aj, "imag22es.png");
  gtk_widget_show (image13);
  gtk_fixed_put (GTK_FIXED (fixed4), image13, 424, 384);
  gtk_widget_set_size_request (image13, 448, 168);

  g_signal_connect ((gpointer) button_aj, "clicked",
                    G_CALLBACK (on_button_aj_clicked),
                    NULL);

  gtk_label_set_mnemonic_widget (GTK_LABEL (label13), aj1);
  ...
  GLADE_HOOKUP_OBJECT (aj, alignment14, "alignment14");
  GLADE_HOOKUP_OBJECT (aj, hbox11, "hbox11");
  GLADE_HOOKUP_OBJECT (aj, image12, "image12");
  GLADE_HOOKUP_OBJECT (aj, label42, "label42");
